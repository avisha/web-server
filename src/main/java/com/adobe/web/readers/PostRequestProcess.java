...
/**
 * this class is used for handling post request from client
 * 
 * @author avijain
 * 
 */
public class PostRequestProcess extends GenericHTTPRequestReader {
	...
	public void handlePostRequest(String requestUri) throws IOException,
		...
		// logPOSTDataFromNonMultipartReq(contentLength);
